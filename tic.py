...
def Game():
    global set2, reset, exi
    reset=tk.Button(win,text='Reset',width=5,font=('Times 26 bold'),bg='blue',fg='black',command=reset1)
    reset.grid(row=0,column=0)
    set2=tk.Button(win,text='Start',width=5,font=('Times 26 bold'),bg='blue',fg='black',command=set)
    set2.grid(row=0,column=6)
    exi=tk.Button(win,text='Exit',width=5,font=('Times 26 bold'),bg='blue',fg='black',command=exit)
    exi.grid(row=0,column=3)
    win.geometry('1920x1080+0+0')
    win.configure(bg='yellow')
    createToolTip(reset,"Click to reset the game")
    createToolTip(set2,"Click to Start the game")
    createToolTip(exi,"Click to Exit the game")
Game()
win.mainloop()
